...
export function CoverageSection() {
    ...
    return (
        <section className="pt-0 pb-12 bg-gradient-to-b from-secondary/30 via-background to-background relative overflow-hidden" id="coverage">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    {/* Info Card / Search Panel */}
                    <div className="lg:col-span-1 bg-card border border-border rounded-2xl p-8 shadow-sm h-full flex flex-col">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="p-3 bg-primary/10 rounded-full">
                                <Search className="w-6 h-6 text-primary" />
                            </div>
                            <h3 className="text-xl font-bold">Find Your Location</h3>
                        </div>
                        ...
                        <div className="space-y-6 flex-grow">
                            ...
                            {searchResult ? (
                                ...
                                /* Default State: Active Zones List */
